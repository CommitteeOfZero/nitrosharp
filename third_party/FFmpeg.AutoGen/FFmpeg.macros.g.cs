...
namespace FFmpeg.AutoGen
{
    public unsafe static partial class ffmpeg
    {
        ...
        /// <summary>E2BIG = 7</summary>
        public const int E2BIG = 0x7;
        /// <summary>EACCES = 13</summary>
        public const int EACCES = 0xd;
        /// <summary>EADDRINUSE = 100</summary>
        public const int EADDRINUSE = 0x64;
        /// <summary>EADDRNOTAVAIL = 101</summary>
        public const int EADDRNOTAVAIL = 0x65;
        /// <summary>EAFNOSUPPORT = 102</summary>
        public const int EAFNOSUPPORT = 0x66;
        /// <summary>EAGAIN = 11</summary>
        public const int EAGAIN = 0xb;
        /// <summary>EALREADY = 103</summary>
        public const int EALREADY = 0x67;
        /// <summary>EBADF = 9</summary>
        public const int EBADF = 0x9;
        /// <summary>EBADMSG = 104</summary>
        public const int EBADMSG = 0x68;
        /// <summary>EBUSY = 16</summary>
        public const int EBUSY = 0x10;
        /// <summary>ECANCELED = 105</summary>
        public const int ECANCELED = 0x69;
        /// <summary>ECHILD = 10</summary>
        public const int ECHILD = 0xa;
        /// <summary>ECONNABORTED = 106</summary>
        public const int ECONNABORTED = 0x6a;
        /// <summary>ECONNREFUSED = 107</summary>
        public const int ECONNREFUSED = 0x6b;
        /// <summary>ECONNRESET = 108</summary>
        public const int ECONNRESET = 0x6c;
        /// <summary>EDEADLK = 36</summary>
        public const int EDEADLK = 0x24;
        /// <summary>EDEADLOCK = EDEADLK</summary>
        public const int EDEADLOCK = EDEADLK;
        /// <summary>EDESTADDRREQ = 109</summary>
        public const int EDESTADDRREQ = 0x6d;
        /// <summary>EDOM = 33</summary>
        public const int EDOM = 0x21;
        /// <summary>EEXIST = 17</summary>
        public const int EEXIST = 0x11;
        /// <summary>EFAULT = 14</summary>
        public const int EFAULT = 0xe;
        /// <summary>EFBIG = 27</summary>
        public const int EFBIG = 0x1b;
        /// <summary>EHOSTUNREACH = 110</summary>
        public const int EHOSTUNREACH = 0x6e;
        /// <summary>EIDRM = 111</summary>
        public const int EIDRM = 0x6f;
        /// <summary>EILSEQ = 42</summary>
        public const int EILSEQ = 0x2a;
        /// <summary>EINPROGRESS = 112</summary>
        public const int EINPROGRESS = 0x70;
        /// <summary>EINTR = 4</summary>
        public const int EINTR = 0x4;
        /// <summary>EINVAL = 22</summary>
        public const int EINVAL = 0x16;
        /// <summary>EIO = 5</summary>
        public const int EIO = 0x5;
        /// <summary>EISCONN = 113</summary>
        public const int EISCONN = 0x71;
        /// <summary>EISDIR = 21</summary>
        public const int EISDIR = 0x15;
        /// <summary>ELOOP = 114</summary>
        public const int ELOOP = 0x72;
        /// <summary>EMFILE = 24</summary>
        public const int EMFILE = 0x18;
        /// <summary>EMLINK = 31</summary>
        public const int EMLINK = 0x1f;
        /// <summary>EMSGSIZE = 115</summary>
        public const int EMSGSIZE = 0x73;
        /// <summary>ENAMETOOLONG = 38</summary>
        public const int ENAMETOOLONG = 0x26;
        /// <summary>ENETDOWN = 116</summary>
        public const int ENETDOWN = 0x74;
        /// <summary>ENETRESET = 117</summary>
        public const int ENETRESET = 0x75;
        /// <summary>ENETUNREACH = 118</summary>
        public const int ENETUNREACH = 0x76;
        /// <summary>ENFILE = 23</summary>
        public const int ENFILE = 0x17;
        /// <summary>ENOBUFS = 119</summary>
        public const int ENOBUFS = 0x77;
        /// <summary>ENODATA = 120</summary>
        public const int ENODATA = 0x78;
        /// <summary>ENODEV = 19</summary>
        public const int ENODEV = 0x13;
        /// <summary>ENOENT = 2</summary>
        public const int ENOENT = 0x2;
        /// <summary>ENOEXEC = 8</summary>
        public const int ENOEXEC = 0x8;
        /// <summary>ENOLCK = 39</summary>
        public const int ENOLCK = 0x27;
        /// <summary>ENOLINK = 121</summary>
        public const int ENOLINK = 0x79;
        /// <summary>ENOMEM = 12</summary>
        public const int ENOMEM = 0xc;
        /// <summary>ENOMSG = 122</summary>
        public const int ENOMSG = 0x7a;
        /// <summary>ENOPROTOOPT = 123</summary>
        public const int ENOPROTOOPT = 0x7b;
        /// <summary>ENOSPC = 28</summary>
        public const int ENOSPC = 0x1c;
        /// <summary>ENOSR = 124</summary>
        public const int ENOSR = 0x7c;
        /// <summary>ENOSTR = 125</summary>
        public const int ENOSTR = 0x7d;
        /// <summary>ENOSYS = 40</summary>
        public const int ENOSYS = 0x28;
        /// <summary>ENOTCONN = 126</summary>
        public const int ENOTCONN = 0x7e;
        /// <summary>ENOTDIR = 20</summary>
        public const int ENOTDIR = 0x14;
        /// <summary>ENOTEMPTY = 41</summary>
        public const int ENOTEMPTY = 0x29;
        /// <summary>ENOTRECOVERABLE = 127</summary>
        public const int ENOTRECOVERABLE = 0x7f;
        /// <summary>ENOTSOCK = 128</summary>
        public const int ENOTSOCK = 0x80;
        /// <summary>ENOTSUP = 129</summary>
        public const int ENOTSUP = 0x81;
        /// <summary>ENOTTY = 25</summary>
        public const int ENOTTY = 0x19;
        // public static environ = _environ;
        /// <summary>ENXIO = 6</summary>
        public const int ENXIO = 0x6;
        /// <summary>EOF = (-1)</summary>
        public const int EOF = -0x1;
        /// <summary>EOPNOTSUPP = 130</summary>
        public const int EOPNOTSUPP = 0x82;
        /// <summary>EOTHER = 131</summary>
        public const int EOTHER = 0x83;
        /// <summary>EOVERFLOW = 132</summary>
        public const int EOVERFLOW = 0x84;
        /// <summary>EOWNERDEAD = 133</summary>
        public const int EOWNERDEAD = 0x85;
        /// <summary>EPERM = 1</summary>
        public const int EPERM = 0x1;
        /// <summary>EPIPE = 32</summary>
        public const int EPIPE = 0x20;
        /// <summary>EPROTO = 134</summary>
        public const int EPROTO = 0x86;
        /// <summary>EPROTONOSUPPORT = 135</summary>
        public const int EPROTONOSUPPORT = 0x87;
        /// <summary>EPROTOTYPE = 136</summary>
        public const int EPROTOTYPE = 0x88;
        /// <summary>ERANGE = 34</summary>
        public const int ERANGE = 0x22;
        /// <summary>EROFS = 30</summary>
        public const int EROFS = 0x1e;
        // public static errno = (*_errno());
        /// <summary>ESPIPE = 29</summary>
        public const int ESPIPE = 0x1d;
        /// <summary>ESRCH = 3</summary>
        public const int ESRCH = 0x3;
        /// <summary>ETIME = 137</summary>
        public const int ETIME = 0x89;
        /// <summary>ETIMEDOUT = 138</summary>
        public const int ETIMEDOUT = 0x8a;
        /// <summary>ETXTBSY = 139</summary>
        public const int ETXTBSY = 0x8b;
        /// <summary>EWOULDBLOCK = 140</summary>
        public const int EWOULDBLOCK = 0x8c;
        /// <summary>EXDEV = 18</summary>
        public const int EXDEV = 0x12;
        /// <summary>EXIT_FAILURE = 1</summary>
        public const int EXIT_FAILURE = 0x1;
        /// <summary>EXIT_SUCCESS = 0</summary>
        public const int EXIT_SUCCESS = 0x0;
        ...
        /// <summary>FILENAME_MAX = 260</summary>
        public const int FILENAME_MAX = 0x104;
        /// <summary>FOPEN_MAX = 20</summary>
        public const int FOPEN_MAX = 0x14;
        ...
        // public static stderr = (__acrt_iob_func(2));
        // public static stdin = (__acrt_iob_func(0));
        // public static stdout = (__acrt_iob_func(1));
        /// <summary>STRUNCATE = 80</summary>
        public const int STRUNCATE = 0x50;
