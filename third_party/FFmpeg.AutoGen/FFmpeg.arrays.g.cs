...
namespace FFmpeg.AutoGen
{
    ...
    public unsafe struct ushort_array2
    {
        public static readonly int Size = 2;
        fixed ushort _[2];
        ...
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (ushort_array2* p = &this) { return p->_[i]; } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (ushort_array2* p = &this) { p->_[i] = value; } }
        }
        public ushort[] ToArray()
        {
            fixed (ushort_array2* p = &this) { var a = new ushort[Size]; for (uint i = 0; i < Size; i++) a[i] = p->_[i]; return a; }
        }
        public void UpdateFrom(ushort[] array)
        {
            fixed (ushort_array2* p = &this) { uint i = 0; foreach(var value in array) { p->_[i++] = value; if (i >= Size) return; } }
        }
        public static implicit operator ushort[](ushort_array2 @struct) => @struct.ToArray();
    }
    ...
    public unsafe struct byte_array12
    {
        ...
        public byte this[uint i]
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (byte_array12* p = &this) { return p->_[i]; } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (byte_array12* p = &this) { p->_[i] = value; } }
        }
        public byte[] ToArray()
        {
            fixed (byte_array12* p = &this) { var a = new byte[Size]; for (uint i = 0; i < Size; i++) a[i] = p->_[i]; return a; }
        }
        public void UpdateFrom(byte[] array)
        {
            fixed (byte_array12* p = &this) { uint i = 0; foreach(var value in array) { p->_[i++] = value; if (i >= Size) return; } }
        }
