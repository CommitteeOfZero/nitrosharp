...
internal sealed class TextRenderContext : IDisposable
{
    ...
    private readonly struct GpuGlyphRun(in RgbaFloat color, in RgbaFloat outlineColor) : GpuType
    {
        public const uint SizeInGpuBlocks = 2;

        private readonly RgbaFloat _color = color;
        private readonly RgbaFloat _outlineColor = outlineColor;
