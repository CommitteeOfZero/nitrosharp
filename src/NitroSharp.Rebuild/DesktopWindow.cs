...
namespace NitroSharp
{
    public sealed class DesktopWindow : GameWindow
    {
        ...
        public ScreenSizeU Size => new((uint)_window.Width, (uint)_window.Height);
