...
internal sealed class XAudio2AudioSource : AudioSource
{
    ...
    private ulong _samplesPlayedStart;
    ...
    public XAudio2AudioSource(XAudio2AudioDevice audioDevice, int bufferSize, int bufferCount)
    {
        ...
        _sourceVoice = audioDevice.Device.CreateSourceVoice(waveFormat, VoiceFlags.NoSampleRateConversion);
    ...
    private void SubmitBuffer(IntPtr data, int size)
    {
        ...
        _sourceVoice.SubmitSourceBuffer(_xaudioBuffer);
    }
