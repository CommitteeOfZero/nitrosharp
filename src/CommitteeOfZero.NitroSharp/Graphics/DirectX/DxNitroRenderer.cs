    ...
    public sealed partial class DxNitroRenderer : INitroRenderer
    {
        ...
        public void DrawSprite(Sprite sprite)
        {
            ...
            if (sprite.SourceRectangle == null)
            {
                ...
                target.DrawBitmap(deviceTexture, dst, sprite.Opacity, InterpolationMode.Cubic, null, null);
            }
            else
            {
                //_rc.DeviceContext.Transform *= SharpDX.Matrix3x2.Scaling(1.5f);
                ...
                target.DrawBitmap(deviceTexture, dst, sprite.Opacity, InterpolationMode.Cubic, srcRect, null);
            }
        }
