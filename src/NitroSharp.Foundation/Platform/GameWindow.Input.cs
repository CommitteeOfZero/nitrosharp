#if !WINDOWS_UWP
using OpenTK.Input;
using MoeKeyboard = NitroSharp.Foundation.Input.Keyboard;
using MoeKey = NitroSharp.Foundation.Input.Key;
using MoeButton = NitroSharp.Foundation.Input.MouseButton;
using MoeMouse = NitroSharp.Foundation.Input.Mouse;
using System;
