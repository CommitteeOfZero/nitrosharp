...
namespace ProjectHoppy
{
    public class TypewriterTest : Game
    {
        ...
        public override void OnGraphicsInitialized()
        {
            ...
            var visual = new VisualComponent { Kind = VisualKind.Text, X = 100, Width = 600, Height = 600, Priority = 1, Color = RgbaValueF.White };
            ...
            Entities.Create("bg")
                .WithComponent(new VisualComponent { Kind = VisualKind.Texture, Width = 800, Height = 640, Priority = 0 })
