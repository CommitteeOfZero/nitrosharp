...
{
    internal abstract class OldAnimationBase : Component
    {
        private float _elapsed;
        private bool _initialized;

        protected OldAnimationBase()
        {
        }

        protected OldAnimationBase(TimeSpan duration, TimingFunction timingFunction = TimingFunction.Linear, bool repeat = false)
        {
            Duration = duration;
