...
{
    internal sealed class OldEntity
    {
        private readonly OldEntityManager _manager;
        private readonly Dictionary<Type, IList<Component>> _components;
        private Dictionary<string, object> _additionalProperties;

        internal OldEntity(OldEntityManager manager, uint id, string name, TimeSpan creationTime)
        {
            _manager = manager;
            Id = id;
            Name = name;
            ...
            var transform = new OldTransform();
        ...
        public OldTransform Transform { get; }
        ...
        public OldEntity WithComponent<T>(T component) where T : Component
        {
            AddComponent(component);
            return this;
        }

        public OldEntity WithParent(OldEntity parentEntity)
        {
        ...
        /// <summary>
        /// Schedules this <see cref="OldEntity"/> to be removed on the next update.
        /// </summary>
        public void Destroy()
        {
