...
namespace NitroSharp.Graphics.Objects
{
    internal sealed class Cube : Visual
    {
        ...
        private VertexRingBuffer<CubeInstanceData> _instanceData;
        ...
        public override void CreateDeviceObjects(RenderContext renderContext)
        {
            ...
            ResourceFactory factory = renderContext.Factory;
            ...
            _viewProjectionSet = factory.CreateResourceSet(new ResourceSetDescription(
                renderContext.SharedConstants.Layout, _viewProjectionBuffer));
            ...
            _pipeline = factory.CreateGraphicsPipeline(
                new GraphicsPipelineDescription(
                    ...
                    shaderSetDesc,
                    new[] { renderContext.SharedConstants.Layout, cubeResourceLayout },
                    renderContext.MainSwapchain.Framebuffer.OutputDescription));

            _instanceData = new VertexRingBuffer<CubeInstanceData>(gd, 1);
        }
        ...
        public override void Render(RenderContext renderContext)
        {
            ...
            _instanceData.End(renderContext.CommandList);
