...
//            foreach (OldEntity e in added)
//            {
//                AssetId asset = _videoClips.Asset.GetRef(e);
//                MediaPlaybackSession session = _content.GetMediaClip(asset);
//                ref PlaybackState playbackState = ref _videoClips.PlaybackState.GetRef(e);
//                PlaybackState.Initialize(ref playbackState, session);

//                ref VideoState videoState = ref _videoClips.VideoState.GetRef(e);
