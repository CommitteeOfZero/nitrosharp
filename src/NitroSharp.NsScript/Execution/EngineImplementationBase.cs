...
{
    public class EngineImplementationBase : IEngineImplementation
    {
        ...
        public virtual string GetCurrentModuleName() => "foo";
        ...
        {
            Interpreter.PushContinuation(_currentParagraph);
        }
