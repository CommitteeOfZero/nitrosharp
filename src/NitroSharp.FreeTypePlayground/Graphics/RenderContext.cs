...
namespace NitroSharp.Graphics
{
    internal sealed class RenderContext
    {
        ...
        public FontLibrary FontService { get; set; }

        public ViewProjection ViewProjection { get; set; }
        public RenderBucket<int> MainBucket { get; set; }
        ...
        public QuadBatcher CreateQuadBatcher(RenderBucket<int> bucket, Framebuffer framebuffer)
        {
